 ...
 */
import com.caso2.domain.*;
import com.caso2.service.*;
...
public class CarritoController {
   ...
   @GetMapping("/carrito/agregar/{idFuncion}")
   ...
   @GetMapping("/carrito/modificar/{idFuncion}")
   ...
   @GetMapping("/carrito/eliminar/{idFuncion}")
